/*
 * File cpplib/matrix1.hxx
 * Written by Erel Segal (mailto:erelsgl@cs.technion.ac.il)
 * Released under the GPL (http://www.gnu.org/licenses/gpl.html)
 * Available online at http://www.cs.technion.ac.il/~erelsgl/bxi/cpp/cpplib/matrix1.hxx
 */

/* matrix1.hxx -- a 2-dim matrix implemented as a 1-dim vector. */



#ifndef __MATRIX1_HXX

#define __MATRIX1_HXX
...
#define MATRIX Matrix1<Data>

#define MATRIXCR const Matrix1<Data>&
...
template<class _Data> class Matrix1 {
...
public:		
	...
	Matrix1 (Size the_rowcount=0, Size the_colcount=0)  { 
	...
	~Matrix1() { /* free();*/  } // nothing is done automatically!
	...
	void truncate (Size the_actual_rowcount, Size the_actual_colcount) {

		my_rowcount = the_actual_rowcount;

		my_colcount = the_actual_colcount;
